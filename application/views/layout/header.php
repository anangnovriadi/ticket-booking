<div class="container-fluid bg-white" id="navbar">
	<div class="row">
		<div class="section font-purple-darken">
			<div class="col-md-2 col-xs-8"><a href="index.html"><img src="<?php echo base_url('assets/front/images/logo.png'); ?>" width="100%"></a></div>
			...
			<div class="col-md-10 col-xs-12 font-sm font-medium text-right">
				<ul>
					<li class="hvr-underline-from-left"><a href="list.html">HOME</a></li>
					<li class="hvr-underline-from-left"><a href="list.html">DESTINASI</a></li>
					<li class="hvr-underline-from-left"><a href="about.html">ABOUT US</a></li>
